...
const UpsertProjectFormModal = ({
  ...
  const { mutate: addProject, isLoading: addingProject } =
    ...
    >
      ...
      <ModalFooter>
        <CustomButton
          ...
          loading={addingProject} // Add your loading state here
          color="primary"
...
export default UpsertProjectFormModal;
